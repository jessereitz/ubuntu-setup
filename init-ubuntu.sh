...
-H -u $SUDO_USER bash -c 'gsettings set org.gnome.shell.extensions.dash-to-dock dock-position BOTTOM'
-H -u $SUDO_USER bash -c 'gsettings set org.gnome.shell.extensions.dash-to-dock show-apps-at-top true'
